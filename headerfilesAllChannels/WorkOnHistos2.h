...
void checkFitCBBW(ofstream &logfile,float mass,float width,string channel, string modelName,string category,double Ymax,bool testGeneratedKinematics=0,bool testKinematicsWithoutSelection=0, bool testMatchedJet=0);
