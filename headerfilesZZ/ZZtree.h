...
// Mon Dec 21 13:36:36 2015 by ROOT version 6.02/05
// from TTree treeMaker/tree
// found on file: crab_BulkGravToZZToZlepZhad_narrow_M-600_13TeV-madgraph.root
//////////////////////////////////////////////////////////
...
//these particles are all ordered by Pt!
   ...
   vector<int>     *genParIndex; //contains literally the indices of the particles again, but there still in order in the file
   vector<int>     *genNMo;
   vector<int>     *genNDa;
   vector<int>     *genMo1;
   vector<int>     *genMo2;
...
//#ifdef ZZtree_cxx
ZZtree::ZZtree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("crab_BulkGravToZZToZlepZhad_narrow_M-600_13TeV-madgraph.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("crab_BulkGravToZZToZlepZhad_narrow_M-600_13TeV-madgraph.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("crab_BulkGravToZZToZlepZhad_narrow_M-600_13TeV-madgraph.root:/tree");
...
Int_t ZZtree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ZZtree::LoadTree(Long64_t entry)
{
...
void ZZtree::Show(Long64_t entry)
{
...
Int_t ZZtree::Cut(Long64_t entry)
{
