...
// Tue Nov 10 13:15:03 2015 by ROOT version 6.02/05
// from TTree tree/tree
// found on file: data/EXOVVTree_BulkGravToWWToWlepWhad_narrow_M_1200_1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data/EXOVVTree_BulkGravToWWToWlepWhad_narrow_M_1200_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data/EXOVVTree_BulkGravToWWToWlepWhad_narrow_M_1200_1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("data/EXOVVTree_BulkGravToWWToWlepWhad_narrow_M_1200_1.root:/ntuplizer");
...
void MyClass::Init(TTree *tree)
{
   ...
   if(fChain->FindBranch("jetAK4_cisv")!=0)
   {
   ...
   {
     fChain->SetBranchAddress("jetAK4_csv",&jetAK4_cisv,&b_jetAK4_cisv);
   }
   ...
   if(fChain->FindBranch("subjetAK8_softdrop_N")!=0)
   {
      fChain->SetBranchAddress("subjetAK8_softdrop_N", &subjetAK8_softdrop_N, &b_subjetAK8_softdrop_N);
   }
   else
   {
    fChain->SetBranchAddress("jetAK8_subjet_softdrop_N", &subjetAK8_softdrop_N, &b_subjetAK8_softdrop_N);
   }
    if(fChain->FindBranch("subjetAK8_softdrop_pt")!=0)
   {
      fChain->SetBranchAddress("subjetAK8_softdrop_pt", &subjetAK8_softdrop_pt, &b_subjetAK8_softdrop_pt);
   }
   else
   {
    fChain->SetBranchAddress("jetAK8_subjet_softdrop_pt", &subjetAK8_softdrop_pt, &b_subjetAK8_softdrop_pt);
   }
   if(fChain->FindBranch("subjetAK8_softdrop_eta")!=0)
   {
      fChain->SetBranchAddress("subjetAK8_softdrop_eta", &subjetAK8_softdrop_eta, &b_subjetAK8_softdrop_eta);
   }
   else
   {
    fChain->SetBranchAddress("jetAK8_subjet_softdrop_eta", &subjetAK8_softdrop_eta, &b_subjetAK8_softdrop_eta);
   }
  if(fChain->FindBranch("subjetAK8_softdrop_mass")!=0)
   {
      fChain->SetBranchAddress("subjetAK8_softdrop_mass", &subjetAK8_softdrop_mass, &b_subjetAK8_softdrop_mass);
   }
   else
   {
    fChain->SetBranchAddress("jetAK8_subjet_softdrop_mass", &subjetAK8_softdrop_mass, &b_subjetAK8_softdrop_mass);
   }
   if(fChain->FindBranch("subjetAK8_softdrop_phi")!=0)
   {
      fChain->SetBranchAddress("subjetAK8_softdrop_phi", &subjetAK8_softdrop_phi, &b_subjetAK8_softdrop_phi);
   }
   else
   {
    fChain->SetBranchAddress("jetAK8_subjet_softdrop_phi", &subjetAK8_softdrop_phi, &b_subjetAK8_softdrop_phi);
   }
  if(fChain->FindBranch("subjetAK8_softdrop_e")!=0)
   {
      fChain->SetBranchAddress("subjetAK8_softdrop_e", &subjetAK8_softdrop_e, &b_subjetAK8_softdrop_e);
   }
   else
   {
    fChain->SetBranchAddress("jetAK8_subjet_softdrop_e", &subjetAK8_softdrop_e, &b_subjetAK8_softdrop_e);
   }
    if(fChain->FindBranch("subjetAK8_softdrop_charge")!=0)
   {
      fChain->SetBranchAddress("subjetAK8_softdrop_charge", &subjetAK8_softdrop_charge, &b_subjetAK8_softdrop_charge);
   }
   else
   {
    fChain->SetBranchAddress("jetAK8_subjet_softdrop_charge", &subjetAK8_softdrop_charge, &b_subjetAK8_softdrop_charge);
   }
   if(fChain->FindBranch("subjetAK8_softdrop_partonFlavour")!=0)
   {
   ...
   {
    fChain->SetBranchAddress("jetAK8_subjet_softdrop_partonFlavour", &subjetAK8_softdrop_partonFlavour, &b_subjetAK8_softdrop_partonFlavour);
   }
  if(fChain->FindBranch("subjetAK8_softdrop_hadronFlavour")!=0)
   {
   ...
   {
    fChain->SetBranchAddress("jetAK8_subjet_softdrop_hadronFlavour", &subjetAK8_softdrop_hadronFlavour, &b_subjetAK8_softdrop_hadronFlavour);
   }
   if(fChain->FindBranch("subjetAK8_softdrop_csv")!=0)
   {
      fChain->SetBranchAddress("subjetAK8_softdrop_csv", &subjetAK8_softdrop_csv, &b_subjetAK8_softdrop_csv);
   }
   else
   {
    fChain->SetBranchAddress("jetAK8_subjet_softdrop_csv", &subjetAK8_softdrop_csv, &b_subjetAK8_softdrop_csv);
   }
