...
// Fri Dec  4 11:57:19 2015 by ROOT version 6.02/05
// from TTree tree/Format: User, data type: BulkGraviton
// found on file: passed_mu_2000.root
//////////////////////////////////////////////////////////

#ifndef passed_mu_jes_h
#define passed_mu_jes_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TBranch        *b_jet_mass;   //!
   TBranch        *b_Mjpruned;   //!
   TBranch        *b_Mjpruned_1;   //!
   TBranch        *b_Mjpruned_2;   //!
   ...
   passed_mu_jes(TTree *tree=0);
   virtual ~passed_mu_jes();
...
//#ifdef passed_mu_jes_cxx
passed_mu_jes::passed_mu_jes(TTree *tree) : fChain(0) 
{
...
passed_mu_jes::~passed_mu_jes()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t passed_mu_jes::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t passed_mu_jes::LoadTree(Long64_t entry)
{
...
void passed_mu_jes::Init(TTree *tree)
{
  ...
  // fChain->SetBranchAddress("Mjpruned_1", &Mjpruned_1, &b_Mjpruned_1);
  // fChain->SetBranchAddress("Mjpruned_2", &Mjpruned_2, &b_Mjpruned_2);
   ...
   //fChain->SetBranchAddress("tau21_1", &tau21_1, &b_tau21_1);
   //fChain->SetBranchAddress("tau21_2", &tau21_2, &b_tau21_2);
...
void passed_mu_jes::Show(Long64_t entry)
{
...
Int_t passed_mu_jes::Cut(Long64_t entry)
{
